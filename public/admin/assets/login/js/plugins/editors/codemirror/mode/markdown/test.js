(function() {
  ...
  MT("consecutiveBackticks",
     "[comment `foo```bar`] hello [comment `country`]");
  ...
  MT("labelDoubleTitle",
     "[link [[foo bar]]:] [string http://example.com/ \"hello\"] \"country\"");
  ...
  MT("emEscapedBySpaceIn",
     "foo [em _bar _ hello_] country");

  MT("emEscapedBySpaceOut",
     "foo _ bar[em _hello_]country");

  MT("emEscapedByNewline",
     "foo",
     "_ bar[em _hello_]country");
  ...
  MT("emStrongAsterisk",
     "[em *foo][em&strong **bar*][strong hello**] country");

  MT("emStrongUnderscore",
     "[em _foo][em&strong __bar_][strong hello__] country");

  // "...same character must be used to open and close an emphasis span.""
  MT("emStrongMixed",
     "[em _foo][em&strong **bar*hello__ country]");

  MT("emStrongMixed",
     "[em *foo][em&strong __bar_hello** country]");
