    ...
    <div class="content pt-4 pb-4">
        <div class="card useradd">
            ...
            <div class="card-body">
                ...
                <form action="{{route("postCustomerCompanyEdit",['id' => $result->id ?? 0])}}" method="post"
                      class="users-content">
                    @csrf
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="form-group row">
                            <label class="control-label col-lg-2">Musteri tipi</label>
                            <div class="col-lg-10">
                                <select name="status" id="status"
                                        class="form-control select-search sms-template-choose"
                                        data-fouc>
                                    <option value=""> --- Musteri tipi seç ---</option>
                                    <option value="1" @if(isset($result->customer_type) && $result->customer_type==1) selected
                                            @endif>
                                        Musteri
                                    </option>
                                    <option value="2" @if(isset($result->customer_type) && $result->customer_type==2) selected
                                            @endif>
                                        Korporativ musteri
                                    </option>
                                    <option value="3" @if(isset($result->customer_type) && $result->customer_type==3) selected
                                            @endif>
                                        Yeni musteri
                                    </option>
                                </select>
                        ...
                        <div class="form-group row">
                            <label class="control-label col-lg-2">Sifaris nomresi</label>
                            <div class="col-lg-10">
                                <input name="order_number" type="text" class="form-control"
                                       value="{{$result->order_number ?? ''}}" placeholder="Sifaris nomresi">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-lg-2">Pulsuz yoxsa endirim</label>
                            <div class="col-lg-10">
                                <select name="is_free" class="select-search form-control">
                                    <option @if(isset($result->is_free) && $result->is_free==1) selected
                                            @endif value="1">Pulsuz
                                    </option>
                                    <option @if(isset($result->is_free) && $result->is_free==0) selected
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <select name="is_fix_or_person" class="select-search form-control">
                                    ...
                                    <option @if(isset($result->is_fix_or_person) && $result->is_fix_or_person==1) selected
                                            @endif value="1">Faiz
                                    </option>
                                    <option @if(isset($result->is_fix_or_person) && $result->is_fix_or_person==0) selected
                                            @endif value="0">Fix
                                    </option>
                                </select>
                            </div>
