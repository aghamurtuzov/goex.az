            ...
            <div class="content">
                ...
                <div class="card">
                    ...
                    <div class="datatable-header">
                        <a href="{{url("balance-add")}}"><button type="button" class="btn btn-primary legitRipple mb-4 px-3">Add new</button></a>
                    </div>
                                ...
                                <div class="list-icons">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a href="{{url("balance-edit")}}" class="dropdown-item"><i class="icon-pencil7"></i>Edit</a>
