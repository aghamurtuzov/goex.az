                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body py-0 p-4" style="margin-bottom: -6px;">
                                        ...
                                        <form id="form"
                                              action="{{route("postCorporativeProfile",['id' => $result->id ?? 0])}}"
                                              method="post"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="text" name="passport_fin"
                                                               ...
                                                               class="form-control" placeholder="Passport Fin">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-lg-2"><label class="col-form-label">Şirkət
                                                            adı</label>
                                                    </div>
                                                    <div class="col-lg-4">
                                                    ...
                                                    <div class="col-lg-2"><label class="col-form-label">Hesab
                                                            nömrəsi</label></div>
                                                    <div class="col-lg-4">
                                                        <input type="text" name="account_number"
                                                               value="{{$result->account_number  ?? ''}}"
                                                               class="form-control" placeholder="Hesab nömrəsi">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                        ...
                                                        @if($balance->balance_id == 1)
                                                            ...
                                                            <div class="col-lg-4">
                                                                <input type="number" name="balance_azn"
                                                                       ...
                                                                       class="form-control" placeholder="AZN">
                                                            </div>
                                                        @endif
                                                            <br>
