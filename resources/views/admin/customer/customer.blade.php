        ...
        <div class="row">
            <div class="content">
                ...
                <div class="card">
                    ...
                    <form
                            action="{{ route('getModuleSearch',['module'=> 'customer','viewFile'=>'customer','path' => 'customer','mainPath'=>'admin','routeId' => request()->route('id')]) }}"
                            method="GET">
                        @csrf
