        ...
        <div class="row">
            ...
            <div class="content">
                ...
                <div class="card p-3">
                    ...
                    <form action="{{ route('getModuleSearch',['module'=> 'orders','viewFile'=>'order-link','path' => 'orders','mainPath'=>'admin','routeId' => request()->route('situation')]) }}"
                          method="GET">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs nav-tabs-highlight nav-justified tabs-width-full">
                                <li class="nav-item"><a href="{{route('orderLink')}}"
                                ...
                                <li class="nav-item"><a
                                            href="{{route('orderLink',['situation' => 1])}}"
                                ...
                                <li class="nav-item"><a
                                            href="{{route('orderLink',['situation' => 6])}}"
                                ...
                                <li class="nav-item"><a
                                            href="{{route('orderLink',['situation' => 7])}}"
                        ...
                        <table class="table datatable-basic">
                            ...
                            @foreach($results as $result)
                                <tr>
                                    <td><b id="customer_code">G-</b><b>{{$result->customOrder->customer_code ?? ''}}</b></td>
                                    <td>{{$result->product_name}}</td>
                                    <td>{{$result->follow_code}}</td>
                                    <td>{{($result->customOrder->first_name ?? '') .' '. ($result->customOrder->last_name ?? '')}}</td>
                                    <td><span id="exchange">AZE</span> {{($result->customOrder->passport ?? '')}}</td>
                                    <td>
