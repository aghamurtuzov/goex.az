            ...
            <div class="content">
                ...
                <div class="card">
                    ...
                    <div class="datatable-header">
                        <a href="{{url("/priorty-add")}}"><button type="button" class="btn btn-primary legitRipple mb-4 px-3">Add new</button></a>
                    </div>
                                ...
                                <div class="list-icons">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a href="{{url("/priorty-edit")}}" class="dropdown-item"><i class="icon-pencil7"></i>Edit</a>
                                            <a href="#" class="dropdown-item"><i class="icon-trash-alt"></i>Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </td>
