                        ...
                        <div class="tab-pane fade" id="tr" role="tabpanel">
                            <fieldset class="mb-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input required type="text" class="form-control" value="{{ $result->title_tr ?? old('title_tr') }}" name="title_tr" placeholder="Title Tr">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2">Metn Tr</label>
                                    <div class="col-lg-10">
                                     <textarea required name="content_tr" class="form-control ckeditor" rows="4" cols="4" required>{{ $result->content_tr ?? old('content_tr') }}</textarea>
