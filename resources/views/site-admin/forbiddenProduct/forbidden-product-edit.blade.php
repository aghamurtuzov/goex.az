                        ...
                        <div class="tab-pane fade show active" id="az" role="tabpanel">
                            <fieldset class="mb-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" value="{{ $result->name_az ?? old('name_az') }}" name="name_az" placeholder="Ad az" required>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
                        <div class="tab-pane fade" id="ru" role="tabpanel">
                            <fieldset class="mb-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" value="{{ $result->name_ru ?? old('name_ru') }}" name="name_ru" placeholder="Ad ru" required>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
                        <div class="tab-pane fade" id="en" role="tabpanel">
                            <fieldset class="mb-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input  type="text" class="form-control" value="{{ $result->name_en ?? old('name_en') }}" name="name_en" placeholder="Ad en" required>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
                        <div class="tab-pane fade" id="tr" role="tabpanel">
                            <fieldset class="mb-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" value="{{ $result->name_tr ?? old('name_tr') }}" name="name_tr" placeholder="Ad tr" required>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
