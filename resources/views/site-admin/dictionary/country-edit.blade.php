        ...
        <div class="card shop">
            ...
            <div class="card-body">
                ...
                <form id="form" action="{{route("postCountryEdit",['id' => $result->id ?? 0])}}" method="post"
                    ...
                    <div class="tab-content" id="myTabContent">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control"
                                               value="{{ $results->name_az ?? old('name_az') }}" name="name_az"
                                               placeholder="Ölkə Adı Az" required>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
                        <div class="tab-pane fade" id="ru" role="tabpanel">
                            <fieldset class="mb-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control"
                                               value="{{ $results->name_ru ?? old('name_ru') }}" name="name_ru"
                                               placeholder="Ölkə Adı Ru" required>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
                        <div class="tab-pane fade" id="en" role="tabpanel">
                            <fieldset class="mb-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control"
                                               value="{{ $results->name_en ?? old('name_en') }}" name="name_en"
                                               placeholder="Ölkə Adı En" required>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
                        <div class="tab-pane fade" id="tr" role="tabpanel">
                            <fieldset class="mb-3">
                                <legend class="text-uppercase font-size-sm font-weight-bold">Ölkə</legend>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2">Ölkə Adı Tr</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control"
                                               value="{{ $results->name_tr ?? old('name_tr') }}" name="name_tr"
                                               placeholder="Ölkə Adı Tr" required>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-2">Ölkə kodu</label>
                        <div class="col-lg-10">
                            <input type="text" class="form-control" value="{{ $results->code ?? old('code') }}"
                                   name="code" placeholder="Ölkə kodu" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <select name="status" id="status" class="form-control" required>
                                <option value="1"
                                        @if(isset($result->status) && $result->status == '1') selected @endif>Aktiv
                                </option>
                                <option value="0"
                                        @if(isset($result->status) && $result->status == '0') selected @endif>Passiv
                                </option>
                            </select>
                        </div>
                    </div>
