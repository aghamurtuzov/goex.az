...
@section("content")
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="az" role="tabpanel">
                                <fieldset class="mb-3">
                                    <legend class="text-uppercase font-size-sm font-weight-bold">Mağaza</legend>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                             <textarea name="content_az" class="ckeditor form-control" required aria-invalid="true">
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10">
            <input type="checkbox" value="1" @if(isset($result->is_partner) && $result->is_partner == '1') checked @endif name="is_partner" style="height: 25px;width: 23px;">
        </div>
    </div>
