        ...
        <div class="row">
            <div class="content">
                ...
                <div class="card">
                    <div class="row p-4">
                        <div class="col-md-6">
                            <h5 class="card-title" style="font-size: 20px;">Faq</h5>
                        </div>
                        <div class="col-md-6 text-right">
                            <h5 class="card-title" style="font-size: 20px;"><a href="{{route("getFaqEdit",0)}}"><button class="btn btn-primary">Əlavə Et</button></a></h5>
                        </div>
                    </div>
                     <form class="p-3"
                                  action="{{ route('getModuleSearch',['module'=> 'faq', 'path' => 'faq','viewFile'=>'faq','mainPath' => 'site-admin' ]) }}"
                                  method="GET">
                                @csrf
                                  <div class="row">
                   <div class="col-md-4">
                    ...
                    <table class="table datatable-basic text-center">
                        ...
                        @foreach($results as $result)
                            <tr>
                                ...
                                @includeIf('partials.status', ['id' => $result->id,'status' => $result->status,'module' => 'faqs'])
                                <td>
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a href="{{route("getFaqEdit",$result->id)}}" class="dropdown-item"><i
                                                        class="icon-pencil5"></i>Redaktə Et</a>
                                                 <a href="javascript:void(0)" data-id="{{ $result->id }}"
                                                   data-module="faqs" class="dropdown-item deleteModal"><i
